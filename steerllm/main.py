...
def main(cfg: DictConfig) -> None:  
    ...
    for prompts_sheet in cfg.prompts_sheets:

        print(prompts_sheet)

        # Load the inputs (prompts)
        prompts_dict = data_handler.csv_to_dictionary(prompts_sheet)

        datset_name = os.path.splitext(os.path.basename(prompts_sheet))[0]
